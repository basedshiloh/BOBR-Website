      ...
      <div className="mx-auto max-w-6xl px-4 py-10">
        <div className="flex flex-col items-start justify-between gap-8 sm:flex-row">
          ...
          <nav className="flex flex-col gap-1.5">
            ...
            <Link href="/blog" className="text-sm text-ink-soft transition-colors hover:text-bobr-600">All Articles</Link>
            <Link href="/about-us" className="text-sm text-ink-soft transition-colors hover:text-bobr-600">About</Link>
